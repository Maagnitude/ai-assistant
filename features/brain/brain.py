...
from features.jokes import Joker
...
class Brain:
    ...
    def process_command(self, command):
        ...
        elif "play my favorite" in command:
            print(command)
            print("Playing your favorite song.")
            self.voice.speak("Here you go boss!")
            self.spier.play_track("All the stars", "Kendrick Lamar")
            self.voice.speak("That's some good taste you got there sir!")
